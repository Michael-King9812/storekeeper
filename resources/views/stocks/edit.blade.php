    ...
    <div class="main-content app-content">
        <div class="container-fluid">
            ...
            <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
                <h1 class="page-title fw-semibold fs-18 mb-0">Update Stocks</h1>
                        ...
                        <div class="card-body">
                            <div class="form-floating mb-3">
                                <input
                                    ...
                                    id="floatingInput"
                                    placeholder="Item"
                                    name=" " value="{{App\Models\Item::find($stock->item_id)->name}}"
                                    disabled
                                />
                            ...
                            <div class="form-floating mb-3">
                                <input
                                    ...
                                    name="quantity" value="{{$stock->qty ?? old('quantity')}}"
                                />
